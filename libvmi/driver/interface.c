    ...
    vmi_instance_t vmi)
{
    ...
    if (NULL != ptrs && NULL != ptrs->create_snapshot_ptr) {
        return ptrs->create_snapshot_ptr(vmi);
    }
    else {
    ...
    vmi_instance_t vmi)
{
    ...
    if (NULL != ptrs && NULL != ptrs->destroy_snapshot_ptr) {
        return ptrs->destroy_snapshot_ptr(vmi);
    }
    else {
