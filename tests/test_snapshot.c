...
START_TEST (test_libvmi_snapshot_create)
{
...
/* snapshot test cases */
TCase *snapshot_tcase (void)
{
    TCase *tc_init = tcase_create("LibVMI Snapshot");
    tcase_add_test(tc_init, test_libvmi_snapshot_create);
    return tc_init;
}
